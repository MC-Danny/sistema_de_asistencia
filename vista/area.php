...
<a href="fpdf/reporte_area.php" target="_blank" class="btn btn-success btn-rounded"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  GENERAR PDF</a>
</div>
      ...
      <div class="modal-body"> 
        ...
        <div class="col-md-7"><br>
          ...
          <div class="col-md-5"><br>
            <label class="form-label">EMPRESA</label>
            <select class="form-select" name="empresa">
                <option value="" selected disabled>Seleccione empresa</option><br>
                <?php
