...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(24, 10, utf8_decode('CELULAR'), 1, 0, 'C', 1);
      $this->Cell(77, 10, utf8_decode('CORREO'), 1, 0, 'C', 1);
      $this->Cell(48, 10, utf8_decode('AREA'), 1, 0, 'C', 1);
      $this->Cell(38, 10, utf8_decode('CARGO'), 1, 1, 'C', 1);
   }
...
while ($datos = $resultado->fetch(PDO::FETCH_OBJ)) {
   $i = $i + 1;
    /* TABLA */
   $pdf->Cell(20, 8, utf8_decode($datos->DNI), 1, 0, 'C', 0);
   $pdf->Cell(72, 8, utf8_decode($datos->NOMBRES." ".$datos->APELLIDOS), 1, 0, 'L', 0);
   $pdf->Cell(24, 8, utf8_decode($datos->CELULAR), 1, 0, 'L', 0);
   $pdf->Cell(77, 8, utf8_decode($datos->CORREO), 1, 0, 'L', 0);
   $pdf->Cell(48, 8, utf8_decode($datos->NOM_AREA), 1, 0, 'L', 0);
   $pdf->Cell(38, 8, utf8_decode($datos->NOM_CARGO), 1, 1, 'L', 0);
